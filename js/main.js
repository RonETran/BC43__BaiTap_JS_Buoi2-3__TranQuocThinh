...
//Chuyển bài
function baiTapMot() {
    document.getElementById('baiMot').style.display = 'block';
    document.getElementById('baiHai').style.display = 'none';
    document.getElementById('baiBa').style.display = 'none';
    document.getElementById('baiBon').style.display = 'none';
    document.getElementById('baiNam').style.display = 'none';
}
function baiTapHai() {
    document.getElementById('baiMot').style.display = 'none';
    document.getElementById('baiHai').style.display = 'block';
    document.getElementById('baiBa').style.display = 'none';
    document.getElementById('baiBon').style.display = 'none';
    document.getElementById('baiNam').style.display = 'none';
}
function baiTapBa() {
    document.getElementById('baiMot').style.display = 'none';
    document.getElementById('baiHai').style.display = 'none';
    document.getElementById('baiBa').style.display = 'block';
    document.getElementById('baiBon').style.display = 'none';
    document.getElementById('baiNam').style.display = 'none';
}
function baiTapBon() {
    ...
    document.getElementById('baiHai').style.display = 'none';
    document.getElementById('baiBa').style.display = 'none';
    document.getElementById('baiBon').style.display = 'block';
    document.getElementById('baiNam').style.display = 'none';
}
function baiTapNam() {
    document.getElementById('baiMot').style.display = 'none';
    ...
    document.getElementById('baiBa').style.display = 'none';
    document.getElementById('baiBon').style.display = 'none';
    document.getElementById('baiNam').style.display = 'block';
}
